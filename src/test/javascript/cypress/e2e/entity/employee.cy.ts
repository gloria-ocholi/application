...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Zachary');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Zachary');

      cy.get(`[data-cy="lastName"]`).type('Kirlin');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Kirlin');

      cy.get(`[data-cy="email"]`).type('Newell86@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Newell86@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('inasmuch where');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'inasmuch where');

      cy.get(`[data-cy="hireDate"]`).type('2025-05-21T14:17');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2025-05-21T14:17');

      cy.get(`[data-cy="salary"]`).type('5998');
      cy.get(`[data-cy="salary"]`).should('have.value', '5998');

      cy.get(`[data-cy="commissionPct"]`).type('14661');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '14661');
