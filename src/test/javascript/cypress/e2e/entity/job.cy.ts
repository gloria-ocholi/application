...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('National Tactics Strategist');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'National Tactics Strategist');

      cy.get(`[data-cy="minSalary"]`).type('5945');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '5945');

      cy.get(`[data-cy="maxSalary"]`).type('11243');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '11243');
