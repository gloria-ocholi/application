...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('considering drat favorable');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'considering drat favorable');

      cy.get(`[data-cy="postalCode"]`).type('indeed flash');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'indeed flash');

      cy.get(`[data-cy="city"]`).type('New Herbertton');
      cy.get(`[data-cy="city"]`).should('have.value', 'New Herbertton');

      cy.get(`[data-cy="stateProvince"]`).type('finally briefly fold');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'finally briefly fold');
