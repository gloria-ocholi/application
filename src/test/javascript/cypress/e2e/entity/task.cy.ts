...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('taut cleverly');
      cy.get(`[data-cy="title"]`).should('have.value', 'taut cleverly');

      cy.get(`[data-cy="description"]`).type('rightfully oily sociable');
      cy.get(`[data-cy="description"]`).should('have.value', 'rightfully oily sociable');
