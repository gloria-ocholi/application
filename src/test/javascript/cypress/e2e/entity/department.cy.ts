...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'similar quip duh' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('via comparison wretched');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'via comparison wretched');
