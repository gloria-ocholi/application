...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0e823e76-c1cc-4b6d-9cf2-ca37448ea5a4' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('9965eddd-0e1f-4790-a314-8ddfd0acfce4');
      cy.get(`[data-cy="name"]`).should('have.value', '9965eddd-0e1f-4790-a314-8ddfd0acfce4');
